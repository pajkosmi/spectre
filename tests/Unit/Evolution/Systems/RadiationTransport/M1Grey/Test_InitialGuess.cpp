...
void test_no_op_initial_guess() {
  using NeutrinoSpecies = neutrinos::ElectronNeutrinos<1>;

  using tilde_e_tag = RadiationTransport::M1Grey::Tags::TildeE<Frame::Inertial,
                                                               NeutrinoSpecies>;
  using tilde_s_tag = RadiationTransport::M1Grey::Tags::TildeS<Frame::Inertial,
                                                               NeutrinoSpecies>;
  ...
  auto null_result = M1Grey::Imex::InitialGuess<return_tags>::apply(
